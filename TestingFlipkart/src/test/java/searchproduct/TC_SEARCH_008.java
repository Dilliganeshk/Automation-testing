...
import org.testng.annotations.Test;
	...
	@BeforeMethod
		...
		void checkfunctionality() throws InterruptedException  {
			...
			driver.findElement(By.xpath("//div[contains(text(),'Availability')]")).click();
			Thread.sleep(5000);
			
			
			
			WebElement actualresult = driver.findElement(By.xpath("//div[contains(text(),'Availability')]"));
